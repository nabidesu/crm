...
def patched_load_audio(file, sr=16000):
    """
    A patched version of Whisper's load_audio function that uses the explicit ffmpeg path
    """
    if isinstance(file, str):
        ...
        # If it's not a string, use the original function
        return original_load_audio(file, sr)


# Patch the Whisper library
